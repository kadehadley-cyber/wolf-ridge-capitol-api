...
<head>
	...
	<title>LUMÉRA | Advanced Exosome Skincare</title>
	<style>
		*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
		...
		.hero::before {
			...
			background: radial-gradient(ellipse at 30% 50%, rgba(196,163,90,0.18) 0%, transparent 60%),
...
<body>
	<nav>
		<div class="nav-inner">
			<a href="/" class="logo">LUM<span>ÉRA</span></a>
			<ul class="nav-links">
	...
	<section class="hero">
		<div class="hero-content">
			<span class="hero-badge">Exosome Biotechnology</span>
			<h1>The Science of <strong>Luminous</strong> Skin</h1>
			<p>LUMÉRA harnesses plant-derived exosome technology to deliver active ingredients at the cellular level — luxury skincare engineered to reveal radiance from within.</p>
			<div>
	...
	<section class="section science-bg" id="science">
		<div class="section-inner">
			<div class="section-header">
				...
				<h2>Powered by <strong>Exosomes</strong></h2>
			...
			<div class="features-grid">
				...
				<div class="feature">
					<div class="feature-icon">&#x1F331;</div>
					<h3>Plant-Derived</h3>
					<p>LUMÉRA exosomes are ethically sourced from botanical stem cells, ensuring purity and biocompatibility with human skin.</p>
				</div>
				<div class="feature">
	...
	<section class="section" id="products">
		<div class="section-inner">
			<div class="section-header">
				...
				<p>Each product in the LUMÉRA line is formulated with our proprietary exosome complex for maximum efficacy.</p>
			</div>
	...
	<section class="section api-section" id="api">
		<div class="section-inner">
			<div class="section-header">
				...
				<p style="color: rgba(255,255,255,0.6);">Full programmatic access to the LUMÉRA product catalog, reviews, and order management.</p>
			</div>
			<div class="api-grid">
	...
	<footer>
		<a href="/" class="logo">LUM<span>ÉRA</span></a>
		<p>Luxury exosome skincare, engineered for radiance.</p>
