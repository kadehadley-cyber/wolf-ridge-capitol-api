-- Migration number: 0001    LUMÉRA brand schema
...
-- Seed the LUMÉRA product catalog. Prices are stored in cents.
INSERT INTO products (name, slug, description, short_description, price, compare_at_price, category, ingredients, benefits, size, is_featured) VALUES
    ('LUMÉRA Rejuvenation Cream', 'lumera-rejuvenation-cream',
     'The LUMÉRA signature exosome-infused facial cream harnesses cutting-edge biotechnology to deliver cellular-level rejuvenation. Plant-derived exosomes penetrate deep into the skin barrier, promoting collagen synthesis and accelerating cell turnover for visibly younger, firmer skin.',
    ...
    ('LUMÉRA Eye Contour Serum', 'lumera-eye-contour-serum',
    ...
    ('LUMÉRA Radiance Serum', 'lumera-radiance-serum',
    ...
    ('LUMÉRA Renewal Night Mask', 'lumera-renewal-night-mask',
    ...
    ('LUMÉRA Gentle Cleanser', 'lumera-gentle-cleanser',
    ...
    ('LUMÉRA Complete Ritual Set', 'lumera-complete-ritual-set',
     'The complete LUMÉRA skincare ritual in one luxurious set. Includes the Gentle Cleanser, Radiance Serum, Rejuvenation Cream, and Renewal Night Mask — everything you need for a transformative morning-to-night routine.',
